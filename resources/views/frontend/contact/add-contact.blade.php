              ...
              <div class="card-header">
                <h3> 
                  ...
                  @else 
                   Add Contact
                  @endif 
                   <a class="btn btn-primary float-right btn-sm" href="{{route('contacts.view')}}"><i class="fa fa-list"></i>  Why Us List</a>
                </h3>
                
              </div><!-- /.card-header -->
              <div class="card-body">
                
                  <form action="{{(@$editData)?route('contacts.update',$editData->id):route('contacts.store')}}" method="post" id="myForm" enctype="multipart/form-data">
                    @csrf
                      <div class="form-row">
