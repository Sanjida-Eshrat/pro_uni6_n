          ...
          <section class="col-md-12">
            <!-- Custom tabs (Charts with tabs)-->
              ...
              <div class="card-header">
                <h3>
                   Add/Edit Teacher Salary
                   <a class="btn btn-success float-right btn-sm" href="{{route('accounts.teacher.salary.view')}}"><i class="fa fa-list"></i> Teacher Salary List</a>
                </h3>
              ...
              <div class="card-body"><!-- card-body -->
                ...
                <script id="document-template" type="text/x-handlebars-template">
                  <form action="{{route('accounts.teacher.salary.store')}}" method="post">
                    @csrf
            ...
            <script type="text/javascript">
              $(document).on('click','#search',function(){
                ...
                $('.notifyjs-corner').html('');
                  ...
                  $.ajax({
                    url: "{{route('accounts.teacher.salary.get-teacher')}}",
                    type: "get",
                    data: {'date':date},
                    beforeSend:function(){  
                    },
