          ...
          <section class="col-md-12">
            <!-- Custom tabs (Charts with tabs)-->
              ...
              <div class="card-body">
                  ...
                  <form action="{{(@$editData)?route('students.registration.update',$editData->student_id):route('students.registration.store')}}" method="post" id="myForm" enctype="multipart/form-data">
                    @csrf
