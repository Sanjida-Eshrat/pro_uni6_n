                      ...
                      <tbody>
                        ...
                        @foreach($allData as $key => $value)
                          <tr class="{{$value->id}}">
                            ...
                            <td> 
                              <a title="Edit" class="btn btn-sm btn-outline-primary" href="{{route('employees.attendance.edit',$value->date)}}"><i class="fa fa-edit"></i></a>
                              <a title="Details" class="btn btn-sm btn-outline-secondary" href="{{route('employees.attendance.details',$value->date)}}"><i class="fas fa-info"></i></a>
                            </td>
                          </tr>
                        @endforeach
                      </tbody>
