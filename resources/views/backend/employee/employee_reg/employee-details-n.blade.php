            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                <div class="text-center">
                  <img  src="{{(!empty($details->image))?url('/upload/employee_images/'.$details->image):url('/upload/d.png')}}" style="width: 70px; height: 80px; border: 1px solid #000;">
                </div>
                ...
                <a href="{{route('employees.reg.view')}}" class="btn btn-primary btn-block"><b>Back</b></a>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
