            ...
            <!-- Custom tabs (Charts with tabs)-->
              ...
              <div class="card-header">
                <h3>
                    ...
                    <a class="btn btn-success float-right btn-sm" href="{{route('teachers.salary.view')}}"><i class="fa fa-plus-circle"></i> Teacher List</a>
                </h3>
                
              </div><!-- /.card-header -->
              <div class="card-body">
                <strong>Teacher Name :</strong> {{$details->name}}, <strong>Teacher ID No :</strong>{{$details->id_no}}
