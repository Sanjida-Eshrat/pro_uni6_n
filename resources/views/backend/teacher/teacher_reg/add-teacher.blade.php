              ...
              <div class="card-header">
                <h3>
                  ...
                  @else 
                   Add Teacher
                  @endif 
                   <a class="btn btn-success float-right btn-sm" href="{{route('teachers.reg.view')}}"><i class="fa fa-list"></i>  Teacher List</a>
                </h3>
                
              </div><!-- /.card-header -->
              <div class="card-body">
                
                  <form action="{{(@$editData)?route('teachers.reg.update',$editData->id):route('teachers.reg.store')}}" method="post" id="myForm" enctype="multipart/form-data">
                    @csrf
