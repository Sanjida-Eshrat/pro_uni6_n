                      ...
                      <tbody>
                        ...
                        @foreach($allData as $key => $value)
                          <tr class="{{$value->id}}">
                            ...
                            <td>
                              <a title="Edit" class="btn btn-sm btn-outline-primary" href="{{route('setups.fee.amount.edit',$value->fee_category_id)}}"><i class="fa fa-edit"></i></a>
                              <a title="Details" class="btn btn-sm btn-outline-secondary" href="{{route('setups.fee.amount.details',$value->fee_category_id)}}"><i class="fa fa-check"></i></a>                             
                            </td>
                          </tr>
                        @endforeach
                      </tbody>
