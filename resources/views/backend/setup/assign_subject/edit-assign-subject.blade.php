        ...
        <div class="row">
          ...
          <section class="col-md-12">
            <!-- Custom tabs (Charts with tabs)-->
              ...
              <div class="card-body">
                <form action="{{route('setups.assign.subject.update',$editData['0']->department_id)}}" method="post" id="myForm" enctype="multipart/form-data">
                 @csrf
                  <div class="add_item">  
                    <div class="form-row">
                      <div class="form-group col-md-4">
                        ...
                        <select name="department_id[]" class="form-control">
                          ...
                          <option value="{{$dept->id}}" {{($editData['0']->department_id==$dept->id)?"selected":""}}>{{$dept->name}}</option>
                          @endforeach
                        </select>
                      </div>
                      <div class="form-group col-md-4">
                        ...
                        <select name="semester_id[]" class="form-control">
                          ...
                          <option value="{{$sem->id}}" {{($editData['0']->semester_id==$sem->id)?"selected":""}}> {{$sem->name}}</option>
                          @endforeach
                        </select>
                      </div> 
